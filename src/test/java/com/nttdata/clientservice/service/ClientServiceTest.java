...
import com.nttdata.clientservice.service.impl.ClientService;
...
//
//        Mockito.when( clientMongoRepository.findById(Mockito.anyString()) ).thenReturn(Single.just(new Client("1", "Daniel", "Montellanos", "email", "pass",
//                "createdAt", "address", "city", "country", "telephone")));
//
...
//                "createdAt", "address", "city", "country", "telephone");
//
//        Mockito.when( clientMongoRepository.save((Client) Mockito.any()))
//                .thenReturn( Single.just(new Client("1", "Daniel", "Montellanos", "email", "pass",
//                        "createdAt", "address", "city", "country", "telephone")) );
//
